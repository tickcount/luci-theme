...
This guide covers the complete development workflow for the Outline theme, from environment setup to building production packages.
...
git clone git@github.com:eamonxg/luci-theme-outline.git
cd luci-theme-outline/.dev/
...
3. CSS requests to `/luci-static/outline/main.css` are rewritten to serve from `.dev/src/media/main.css`
...
│   └── images/            # Logo assets
└── resources/
    ├── menu-outline.js     # Menu configuration (minified via Terser)
    └── view/outline/
...
4. Static assets copied from `.dev/public/outline/`
...
**Workflow File:** `.github/workflows/build-and-release-outline.yml`
...
│   ├── public/outline/              # Public static assets
│   │   ├── fonts/                  # Web fonts (Lato)
│   │   └── images/                 # Theme images
...
│   ├── outline/                     # Theme CSS and assets
│   │   ├── fonts/                  # Built font files
│   │   ├── images/                 # Built images
│   │   └── main.css                # Compiled CSS
│   └── resources/                  # Built JavaScript modules
│       ├── view/                   # Minified view components
│       └── menu-outline.js          # Minified menu logic
├── root/etc/uci-defaults/          # OpenWrt system integration
│   └── 30_luci-theme-outline        # Theme auto-setup script
├── ucode/template/themes/outline/   # LuCI ucode templates
